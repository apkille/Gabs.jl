@testitem "Symbolic Unitaries" begin
    ...
    for (name, op_func, factor) in [("squeeze", squeeze, 1), ("two-mode squeeze", twosqueeze, 2)]
        @testset "Symbolic $name operator" begin
            ...
            @test_broken op_func(Array, factor * qpairbasis, r, theta) isa GaussianUnitary
            @test_broken op_func(SVector, SMatrix, factor * qpairbasis, r, theta) isa GaussianUnitary
            ...
            @test_broken op_func(Array, factor * qpairbasis, rs_vec, thetas_vec) isa GaussianUnitary
            @test_broken op_func(SVector, SMatrix, factor * qpairbasis, rs_vec, thetas_vec) isa GaussianUnitary
    ...
    for (name, op_func, factor) in [("phase-shift", phaseshift, 1), ("beamsplitter", beamsplitter, 2),("displace", displace, 1)]
        @testset "Symbolic $name operator" begin
            ...
            @test_broken op_func(Array, factor * qpairbasis, theta) isa GaussianUnitary
            @test_broken op_func(SVector, SMatrix, factor * qpairbasis, theta) isa GaussianUnitary
            ...
            @test_broken op_func(Array, factor * qpairbasis, thetas_vec) isa GaussianUnitary
            @test_broken op_func(SVector, SMatrix, factor * qpairbasis, thetas_vec) isa GaussianUnitary
